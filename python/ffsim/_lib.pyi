...
def make_strings(norb: int, nocc: int) -> np.ndarray: ...
def gen_occslst(norb: int, nocc: int) -> np.ndarray: ...
def gen_linkstr_index(norb: int, nocc: int) -> np.ndarray: ...
def gen_linkstr_index_trilidx(norb: int, nocc: int) -> np.ndarray: ...
def addr_from_occupied(norb: int, nocc: int, occupied: list[int]) -> int: ...
